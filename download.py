...
def process_item(id, directory, rename):
    ...
    if '/file/' in url:
        ...
        file_path = os.path.join(directory, (file_name if rename is None else rename))
...
if __name__ == '__main__':
    ...
    process_item(id, directory, rename)